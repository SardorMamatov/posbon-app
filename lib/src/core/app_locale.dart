...
class AppStrings {
  ...
  static const Map<AppLocale, Map<String, String>> _data = {
    AppLocale.uz: {
      ...
      'results.delete_all_risky': 'Xavflilarni o\'chirish ({n} ta)',
      'results.delete_all_confirm': 'Xavfli va shubhali {n} ta fayl o\'chirib tashlanadi. Davom etasizmi?',
      'results.delete_all_done': '{n} ta fayl o\'chirildi.',
      ...
      'app_detail.whitelist_add': 'Ishonchlilar ro\'yxatiga qo\'shish',
      'app_detail.whitelist_remove': 'Ishonchlilar ro\'yxatidan olib tashlash',
      ...
      'settings.monitoring_desc':
          'Fonda ishlaydi. Yangi APK yuklansa darhol bildirishnoma yuboriladi.',
      ...
      'settings.full_scan': 'To\'liq skanerlash',
      'settings.full_scan_desc': 'VirusTotal orqali chuqur tekshirish (sekinroq)',
      'settings.screen_protection': 'Ekran himoyasi',
      'settings.screen_protection_desc': 'Skrinshot va ekranni yozishni bloklaydi',
      'settings.whitelist': 'Ishonchli ilovalar',
      'settings.whitelist_desc': 'Foydalanuvchi qo\'shgan ishonchli ilovalar',
      'settings.whitelist_empty': 'Hali ilova qo\'shilmagan',
      'settings.whitelist_remove': 'O\'chirish',
      'settings.integrity': 'Tizim holati',
      'settings.integrity_ok': 'Xavf aniqlanmadi',
      'settings.integrity_rooted': 'Root kiritilgan',
      'settings.integrity_adb': 'USB debug yoqilgan',
      'settings.integrity_test_keys': 'Test-keys build',
...
Telegram: https://t.me/Mamatov_Ramazon''',
      ...
      'watcher.ongoing_title': 'POSBON himoya rejimida',
      'watcher.ongoing_body':
          'Yangi APK yuklansa avtomatik aniqlanadi va sizga xabar beriladi.',
      'watcher.alert_title': '⚠️ Yangi APK aniqlandi',
      'watcher.alert_body':
          '{name} yuklandi. Tekshirish uchun bosing.',
      'watcher.stop_action': 'To\'xtatish',
      ...
      'files.all_scanned': 'Barcha fayllar allaqachon tekshirilgan.',
      'files.scan': 'Tekshirish',
      'files.rescan': 'Qayta tekshirish',
      'files.delete': 'Faylni o\'chirish',
      'files.delete_confirm': 'Ushbu faylni o\'chirib tashlamoqchimisiz?',
      'files.deleted': 'Fayl o\'chirildi.',
      'files.info_size': 'Hajmi',
      'files.info_date': 'Sana',
      'files.info_path': 'Yo\'l',
      'files.info_status': 'Holati',
      'files.status_scanned': 'Tekshirilgan',
      'files.status_not_scanned': 'Tekshirilmagan',
    ...
    AppLocale.ru: {
      ...
      'results.delete_all_risky': 'Удалить опасные ({n})',
      'results.delete_all_confirm': 'Будет удалено {n} опасных/подозрительных файлов. Продолжить?',
      'results.delete_all_done': '{n} файлов удалено.',
      ...
      'app_detail.whitelist_add': 'Добавить в доверенные',
      'app_detail.whitelist_remove': 'Убрать из доверенных',
      ...
      'settings.monitoring_desc':
          'Работает в фоне. Уведомление приходит сразу при загрузке нового APK.',
      'settings.about': 'О приложении',
      'settings.version': 'Версия',
      'settings.choose_language': 'Выберите язык',
      'settings.contact_telegram': 'Telegram',
      'settings.contact_email': 'Email',
      'settings.full_scan': 'Полное сканирование',
      'settings.full_scan_desc': 'Глубокая проверка через VirusTotal (медленнее)',
      'settings.screen_protection': 'Защита экрана',
      'settings.screen_protection_desc': 'Блокирует снимки и запись экрана',
      'settings.whitelist': 'Доверенные приложения',
      'settings.whitelist_desc': 'Приложения, добавленные вручную',
      'settings.whitelist_empty': 'Ничего не добавлено',
      'settings.whitelist_remove': 'Удалить',
      'settings.integrity': 'Целостность системы',
      'settings.integrity_ok': 'Угроз не обнаружено',
      'settings.integrity_rooted': 'Обнаружен root',
      'settings.integrity_adb': 'USB-отладка включена',
      'settings.integrity_test_keys': 'Тестовая сборка (test-keys)',
...
Telegram: https://t.me/Mamatov_Ramazon''',
      ...
      'watcher.ongoing_title': 'POSBON в режиме защиты',
      'watcher.ongoing_body':
          'Новые APK будут обнаружены автоматически — мы сообщим вам.',
      'watcher.alert_title': '⚠️ Обнаружен новый APK',
      'watcher.alert_body':
          '{name} загружен. Нажмите для проверки.',
      'watcher.stop_action': 'Остановить',
      ...
      'files.all_scanned': 'Все файлы уже проверены.',
      'files.scan': 'Проверить',
      'files.rescan': 'Перепроверить',
      'files.delete': 'Удалить файл',
      'files.delete_confirm': 'Вы действительно хотите удалить этот файл?',
      'files.deleted': 'Файл удалён.',
      'files.info_size': 'Размер',
      'files.info_date': 'Дата',
      'files.info_path': 'Путь',
      'files.info_status': 'Статус',
      'files.status_scanned': 'Проверен',
      'files.status_not_scanned': 'Не проверен',
      'files.subtitle_ok_long':
    ...
    AppLocale.en: {
      ...
      'results.delete_all_risky': 'Delete risky ({n})',
      'results.delete_all_confirm': '{n} dangerous/suspicious file(s) will be deleted. Continue?',
      'results.delete_all_done': '{n} file(s) deleted.',
      ...
      'app_detail.whitelist_add': 'Add to trusted list',
      'app_detail.whitelist_remove': 'Remove from trusted list',
      ...
      'settings.monitoring_desc':
          'Runs in background. Alerts you the moment a new APK lands.',
      'settings.about': 'About the app',
      'settings.version': 'Version',
      'settings.choose_language': 'Choose language',
      'settings.contact_telegram': 'Telegram',
      'settings.contact_email': 'Email',
      'settings.full_scan': 'Full Scan',
      'settings.full_scan_desc': 'Deep check via VirusTotal (slower)',
      'settings.screen_protection': 'Screen Protection',
      'settings.screen_protection_desc': 'Blocks screenshots and screen recording',
      'settings.whitelist': 'Trusted Apps',
      'settings.whitelist_desc': 'Apps you added manually to the trusted list',
      'settings.whitelist_empty': 'No apps added yet',
      'settings.whitelist_remove': 'Remove',
      'settings.integrity': 'System Integrity',
      'settings.integrity_ok': 'No threats detected',
      'settings.integrity_rooted': 'Root access detected',
      'settings.integrity_adb': 'USB debug enabled',
      'settings.integrity_test_keys': 'Test-keys build',
...
Telegram: https://t.me/Mamatov_Ramazon''',
      ...
      'watcher.ongoing_title': 'POSBON is on guard',
      'watcher.ongoing_body':
          'Newly downloaded APKs will be detected automatically and you will be alerted.',
      'watcher.alert_title': '⚠️ New APK detected',
      'watcher.alert_body':
          '{name} was downloaded. Tap to scan.',
      'watcher.stop_action': 'Stop',
      ...
      'files.all_scanned': 'All files have already been scanned.',
      'files.scan': 'Scan',
      ...
      'files.info_date': 'Date',
      'files.info_path': 'Path',
      'files.info_status': 'Status',
      'files.status_scanned': 'Scanned',
      'files.status_not_scanned': 'Not scanned',
      'files.subtitle_ok_long':
